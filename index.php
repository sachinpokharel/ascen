...
<head>
    ...
    <!--====== Title ======-->
    <title>ABC-your dream our help</title>

    <!--====== Favicon Icon ======-->
    <link rel="shortcut icon" href="assets/images/abcfavicon.png" type="image/png">
                    ...
                    <div class="col-lg-12">
                        <nav class="navbar navbar-expand-lg">
                            <a class="navbar-brand" href="#">
                                <img src="assets/images/icon512.png" alt="Logo" height="80px">

                            </a><h4>
                            Ascension <br> Bussiness<br> concern</h4>
                                ...
                                <div class="container">
                                    <div class="row justify-content-center">
                                        <div class="col-xl-6 col-lg-7 col-sm-10">
                                            <h2 class="carousel-title">Refreshing Design & comfortable pricing</h2>
                                            <ul class="carousel-btn rounded-buttons">
                                                <li><a class="main-btn rounded-three" href="#portfolio">VIEW MORE</a></li>
                        ...
                        <div class="carousel-item bg_cover" style="background-image: url(assets/images/slider-2.jpg)">
                            <div class="carousel-caption">
                                <div class="container">
                                    <div class="row justify-content-center">
                                        <div class="col-xl-6 col-lg-7 col-sm-10">
                                            <h2 class="carousel-title">Based on Latest Technology & Premium Quality Paints</h2>
                                            <ul class="carousel-btn rounded-buttons">
                                               <li><a class="main-btn rounded-three" href="#portfolio">VIEW MORE</a></li>
                                                <li><a class="main-btn rounded-one" href="#contact">CONTACT Us</a></li>
                                            </ul>
                        ...
                        <div class="carousel-item bg_cover" style="background-image: url(assets/images/slider-3.jpg)">
                            <div class="carousel-caption">
                                <div class="container">
                                    <div class="row justify-content-center">
                                        <div class="col-xl-6 col-lg-7 col-sm-10">
                                            <h2 class="carousel-title">Choose your textures & design for walls ceilings </h2>
                                            <ul class="carousel-btn rounded-buttons">
                                                <li><a class="main-btn rounded-three" href="#portfolio">VIEW MORE</a></li>
                                                <li><a class="main-btn rounded-one" href="#contact">CONTACT Us</a></li>
                                            </ul>
    ...
    <div class="sidebar-right">
        ...
        <div class="sidebar-content">
            <div class="sidebar-logo text-center">
                <a href="#"><img src="assets/images/icon512.png" alt="Logo" width="120%"></a>
            </div> <!-- logo -->
            ...
            <div class="sidebar-social d-flex align-items-center justify-content-center">
                ...
                <ul>
                    ...
                    <li><a target="" href="https://www.facebook.com/GRANITEPAINTNEPAL"><i class="lni-facebook-filled"></i></a></li>
                            <li><a href="https://twitter.com/"><i class="lni-twitter-original"></i></a></li>
                            <li><a target="" href="https://www.instagram.com/granite_texture_paints/"><i class="lni-instagram-original"></i></a></li>
                </ul>
            </div> <!-- sidebar social -->
        </div> <!-- content -->
    </div>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="about-image text-center wow fadeInUp" data-wow-duration="1.5s" data-wow-offset="100">
                        <img src="assets/images/product.jpg" alt="services">
                    </div>
                <div class="col-xl-6 col-lg-8">
                   <!--  <div class="about-image text-center wow fadeInUp" data-wow-duration="1.5s" data-wow-offset="100">
                    ...
                    <div class="section-title text-center mt-30 pb-40">
                        <h4 class="title wow fadeInUp" data-wow-duration="1.5s" data-wow-delay="0.6s">The future of your house designing starts here</h4>
                        <p class="text wow fadeInUp" data-wow-duration="1.5s" data-wow-delay="1s">feel free to  consult and contact with us  .</p>
                    </div> <!-- section title -->
                </div>
            </div> <!-- row -->
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="single-about d-sm-flex mt-30 wow fadeInUp" data-wow-duration="1.5s" data-wow-delay="1.2s">
                        <div class="about-icon">
                            <img src="assets/images/timeglass.png" alt="Icon">
                        </div>
                        <div class="about-content media-body">
                            <h4 class="about-title">Durable colors</h4>
                ...
                <div class="col-lg-6">
                    <div class="single-about d-sm-flex mt-30 wow fadeInUp" data-wow-duration="1.5s" data-wow-delay="1.4s">
                        <div class="about-icon">
                            <img src="assets/images/weather.png" alt="Icon">
                        </div>
                        <div class="about-content media-body">
                            <h4 class="about-title">Designed for every weathers & walls</h4>
                            <p class="text">Poorly designed presentations are a thing of the past. Create beautiful and high-quality content that is aligned.</p>
                        </div>
                    </div> <!-- single about -->
                </div>
                <div class="col-lg-6">
                    <div class="single-about d-sm-flex mt-30 wow fadeInUp" data-wow-duration="1.5s" data-wow-delay="1.6s">
                        <div class="about-icon">
                            <img src="assets/images/paintbox.jpg" alt="Icon">
                        </div>
                        <div class="about-content media-body">
                            <h4 class="about-title">Work/paints anywhere</h4>
                            <p class="text">Poorly designed presentations are a thing of the past. Create beautiful and high-quality content that is aligned.</p>
                        </div>
                    </div> <!-- single about -->
                </div>
                <div class="col-lg-6">
                    <div class="single-about d-sm-flex mt-30 wow fadeInUp" data-wow-duration="1.5s" data-wow-delay="1.8s">
                        <div class="about-icon">
                            <img src="assets/images/color.png" alt="Icon">
                        </div>
                        <div class="about-content media-body">
                            <h4 class="about-title">update with latest technology colors</h4>
                            <p class="text">Poorly designed presentations are a thing of the past. Create beautiful and high-quality content that is aligned.</p>
                        </div>
                    </div> <!-- single about -->
                </div>
  ...
  <div class="popup" id="popup">
            ...
            <div class="row grid">
                    ...
                    <div class="single-portfolio mt-30 wow fadeInUp" data-wow-duration="1.5s" data-wow-delay="0.4s">
                        <div class="portfolio-image">
                            ...
                            <div class="portfolio-overlay d-flex align-items-center justify-content-center">
                                <div class="portfolio-content">
                                    <div class="portfolio-icon">
                                        <a class="image-popup" href="assets/images/home1.jpg"><i class="lni-zoom-in"></i></a>
                                    </div>
                                    <div class="portfolio-icon">
                                        <a href="#"><i class="lni-link"></i></a>
                                    </div>
                    ...
                    <div class="single-portfolio mt-30 wow fadeInUp" data-wow-duration="1.5s" data-wow-delay="0.7s">
                        <div class="portfolio-image">
                            ...
                            <div class="portfolio-overlay d-flex align-items-center justify-content-center">
                                <div class="portfolio-content">
                                    <div class="portfolio-icon">
                                        <a class="image-popup" href="assets/images/home7.jpg"><i class="lni-zoom-in"></i></a>
                                    </div>
                                    <div class="portfolio-icon">
                                        <a href="#"><i class="lni-link"></i></a>
                                    </div>
                    ...
                    <div class="single-portfolio mt-30 wow fadeInUp" data-wow-duration="1.5s" data-wow-delay="0.2s">
                        <div class="portfolio-image">
                            ...
                            <div class="portfolio-overlay d-flex align-items-center justify-content-center">
                                <div class="portfolio-content">
                                    <div class="portfolio-icon">
                                        <a class="image-popup" href="assets/images/home3.jpg"><i class="lni-zoom-in"></i></a>
                                    </div>
                                    <div class="portfolio-icon">
                                        <a href="#"><i class="lni-link"></i></a>
                                    </div>
                    ...
                    <div class="single-portfolio mt-30 wow fadeInUp" data-wow-duration="1.5s" data-wow-delay="0.4s">
                        <div class="portfolio-image">
                            ...
                            <div class="portfolio-overlay d-flex align-items-center justify-content-center">
                                <div class="portfolio-content">
                                    <div class="portfolio-icon">
                                        <a class="image-popup" href="assets/images/home6.jpg"><i class="lni-zoom-in"></i></a>
                                    </div>
                                    <div class="portfolio-icon">
                                        <a href="#"><i class="lni-link"></i></a>
                                    </div>
                    ...
                    <div class="single-portfolio mt-30 wow fadeInUp" data-wow-duration="1.5s" data-wow-delay="0.7s">
                        <div class="portfolio-image">
                            ...
                            <div class="portfolio-overlay d-flex align-items-center justify-content-center">
                                <div class="portfolio-content">
                                    <div class="portfolio-icon">
                                        <a class="image-popup" href="assets/images/home2.jpg"><i class="lni-zoom-in"></i></a>
                                    </div>
                                    <div class="portfolio-icon">
                                        <a href="#"><i class="lni-link"></i></a>
                                    </div>
                ...
                <div class="col-lg-4 col-sm-6 branding-3 marketing-3">
                    <div class="single-portfolio mt-30 wow fadeInUp" data-wow-duration="1.5s" data-wow-delay="0.7s">
                        ...
                        <div class="portfolio-text">
                            <h4 class="portfolio-title"><a href="#">hello</a></h4>
                            <p class="text">Short description for the ones who look for something new. Awesome!</p>
                        </div>
                    </div> <!-- single portfolio -->
                </div>
    ...
    <section id="testimonial" class="testimonial-area">
        <div class="container">
            ...
            <h3>Our Client Reviews on US</h3>
            <div class="row">
                <div class="col-lg-12">
                    <div class="row testimonial-active">
                        <div class="col-lg-4">
                            <div class="single-testimonial mt-30 mb-30 text-center">
                                <div class="testimonial-image">
                                    <img src="assets/images/person.svg" alt="Author">
                                </div>
                                ...
                                <div class="testimonial-content">
                                    ...
                                    <h6 class="author-name">Ram Bahadur</h6>
                                    <span class="sub-title">Jadibuti ,kathmandu</span>
                                </div>
                        ...
                        <div class="col-lg-4">
                            <div class="single-testimonial mt-30 mb-30 text-center">
                                ...
                                <div class="testimonial-content">
                                    <p class="text">Stop wasting time and money designing and managing a website that doesn’t get results. Happiness guaranteed! Stop wasting time and money designing and managing a website that doesn’t get results. Happiness guaranteed!</p>
                                    <h6 class="author-name">sabin bhattarai</h6>
                                    <span class="sub-title">Sallaghari, Bhaktapur</span>
                                </div>
                            </div> <!-- single testimonial -->
                        </div>
                        <div class="col-lg-4">
                            <div class="single-testimonial mt-30 mb-30 text-center">
                                ...
                                <div class="testimonial-content">
                                    <p class="text">Stop wasting time and money designing and managing a website that doesn’t get results. Happiness guaranteed! Stop wasting time and money designing and managing a website that doesn’t get results. Happiness guaranteed!</p>
                                    <h6 class="author-name">Sankar Poudel</h6>
                                    <span class="sub-title">Gatthaghar, Bhaktapur</span>
                                </div>
                            </div> <!-- single testimonial -->
                        </div>
                        <div class="col-lg-4">
                            <div class="single-testimonial mt-30 mb-30 text-center">
                                ...
                                <div class="testimonial-content">
                                    <p class="text">Stop wasting time and money designing and managing a website that doesn’t get results. Happiness guaranteed! Stop wasting time and money designing and managing a website that doesn’t get results. Happiness guaranteed!</p>
                                    <h6 class="author-name">Nirman Shrestha</h6>
                                    <span class="sub-title">sanothimi, bhaktapur</span>
                                </div>
                            </div> <!-- single testimonial -->
                        </div>
                    </div> <!-- row -->
            ...
            <div class="row align-items-center">
                <div class="col-lg-5">
                    <div class="call-action-content mt-45">
                        <h3 class="action-title">Get latest offers & updates!</h3>
                        <p class="text">We never spam your email</p>
                    </div> <!-- call action content -->
                </div>
                <div class="col-lg-7">
                    <div class="call-action-form mt-50">
                        <form action="assets/sus.php" method="post">
                            <input type="email" name="email" placeholder="Enter your email">
                            <div class="action-btn rounded-buttons">
                                <button name="submit" class="main-btn rounded-three">subscribe</button>
                            </div>
                        </form>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <div class="section-title text-center pb-20">
                        ...
                        <p class="text">Stop wasting time and money on  yearly coloring .
                            Give us a chance to  color your home & we guarantee your happiness. <br>Happiness guaranteed!</p>
                    </div> <!-- section title -->
                </div>
            </div> <!-- row -->
            <div class="row">
                <div class="col-lg-6">
                    <div class="contact-two mt-50 wow fadeIn" data-wow-duration="1.5s" data-wow-delay="0.2s">
                        ...
                        <p class="text">You can directly contact or visit to our office & store located at :</p>
                        <ul class="contact-info">
                            <li><i class="lni-money-location"></i> aside sky bridge ,Gatthaghar ,
                            Bhaktapur  Nepal</li>
                            <li><i class="lni-phone-handset"></i><a href="tel:980000000">1234567890</a></li>
                            <li><i class="lni-envelope"></i> <a href="mailto:ascesionbusinessconcern@gmail.com">ascensionbusinessconcern@gmail.com</a></li>
                        </ul>
                    </div> <!-- contact two -->
                </div>
                <div class="col-lg-6">
                    <div class="contact-form form-style-one mt-35 wow fadeIn" data-wow-duration="1.5s" data-wow-delay="0.5s">  
                        <h4 class="contact-title">you can give us too</h4>
                        <form  id="contact-form" action="assets/contact.php" method="post">
                            ...
                            <div class="form-input rounded-buttons mt-20">
                                <button type="submit" name="submit" class="main-btn rounded-three">Submit</button>
                ...
                <div class="row">
                    <div class="col-lg-3 col-sm-6">
                        <div class="footer-link">
                            <h6 class="footer-title">)ur Company</h6>
                            <ul>
                                <li><a href="#about">About</a></li>
                                <li><a href="#contact">Contact</a></li>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-5">
                        <div class="copyright text-center text-lg-left mt-10">
                           <!--  <p class="text">Crafted by <a style="color: #38f9d7" rel="nofollow" href="https://ascensionbusinessconcern.com.np">UIdeck</a> and UI Elements from <a style="color: #38f9d7" rel="nofollow" target="" href="https://ascensionbusinessconcern.com.np">Ayro UI</a></p> -->
                        </div> <!--  copyright -->
                    </div>
                    <div class="col-lg-2">
                        <div class="footer-logo text-center mt-10">
                            <a href="index.html"><img height="  100px" width=" 200px" src="assets/images/icon512.png" alt="Logo"></a>
                        </div> <!-- footer logo -->
                    </div>
                    <div class="col-lg-5">
                        <ul class="social text-center text-lg-right mt-10">
                            ...
                            <li><a href="https://www.instagram.com/granite_texture_paints/"><i class="lni-instagram-original"></i></a></li>
